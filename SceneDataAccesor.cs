...
public class SceneDataAccesor
{
    ...
    public SceneDataAccesor()
    {
        ...
        antiqueObjects[1].option1 = "Nah, I’m not into that sort of thing";
        ...
        antiqueObjects[2].option1 = "Nah, I’m not into that sort of thing";
        ...
        antiqueObjects[2].successExplanation = "Good choice, you should avoid the use of social media to purchase controlled goods. Let's see what could have gone wrong if you made the wrong choice.";
